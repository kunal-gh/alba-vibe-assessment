  ...
  return (
    <div className="flex items-center justify-center min-h-[60vh] p-4">
      ...
      >
        ...
        <div className="mt-8 space-y-3" aria-label="Candidate results loading">
          <p className="text-xs font-black tracking-widest uppercase text-gray-400">Preparing candidate evidence</p>
          {[0, 1, 2].map((item) => (
            <div key={item} className="border-4 border-black p-4 bg-white animate-pulse">
              <div className="h-3 w-1/3 bg-gray-200 mb-3" />
              <div className="h-2 w-full bg-gray-100 mb-2" />
              <div className="h-2 w-4/5 bg-gray-100" />
            </div>
          ))}
        </div>
      </motion.div>
